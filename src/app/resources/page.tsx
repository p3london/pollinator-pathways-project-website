...
export default async function Page() {
  ...
  return (
    <LayoutRoot footer={footer} pathname="/resources" navBarItems={nav.items}>
      {isEditable ? (
        <PageWithTinaHook tina={res} serverProps={{}} />
      ) : (
        <PageComponent data={res.data} serverProps={{}} />
      )}
    </LayoutRoot>
  );
}
...
export const metadata = {
  title: "Resources" + METADATA_TITLE_SUFFIX,
  description:
